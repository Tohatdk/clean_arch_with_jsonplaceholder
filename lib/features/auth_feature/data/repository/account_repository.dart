...
class AccountRepositoryImpl implements AccountRepository {
  ...
  Future<AccountEntity?> signIn({ required String email,
    ...
    final userCredentials = await _accountDataSource.signIn(email:email , password: password);
  ...
  required String password,})async{
    final userCredentials = await _accountDataSource.createUser(email:email , password: password);
    final accountEntity = userCredentials?.toEntity();
    return accountEntity;
  }
  @override
